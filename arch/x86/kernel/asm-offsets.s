...
.ascii "->TASK_threadsp $8608 offsetof(struct task_struct, thread.sp)"	#
# 0 "" 2
# 34 "arch/x86/kernel/asm-offsets.c" 1
	
.ascii "->TASK_stack_canary $2168 offsetof(struct task_struct, stack_canary)"	#
# 0 "" 2
...
.ascii "->TASK_addr_limit $8744 offsetof(struct task_struct, thread.addr_limit)"	#
# 0 "" 2
